          ...
          <el-form>
            ...
            <el-form-item v-if="props.groups.length">
              <el-select v-model="newBubble.groupId" placeholder="Select Group">
                ...
                <el-option v-for="group in props.groups" :key="group.id" :label="group.name" :value="group.id"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
          ...
          <el-form>
            <el-form-item>
              <el-select v-model="newRelationship.source" placeholder="Select Source">
                <el-option v-for="bubble in props.mapData.bubbles" :key="bubble.id" :label="bubble.text" :value="bubble.id"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
            ...
            <el-form-item>
              <el-button type="primary" @click="handleAddRelationship">Add Relationship</el-button>
            </el-form-item>
          </el-form>
        </div>
      </el-col>
